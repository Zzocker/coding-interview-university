...
- ### Hash table
    - [X] Videos:
        - [Hashing with Chaining (video)](https://youtu.be/0M_kIqhwbFo?si=ICTN2rFqbJ6w3Hcu&t=812)
        - [Hash Functions](https://youtu.be/0M_kIqhwbFo?si=Xc_EE5R6S_qz9euY&t=2530)
        - [Table Doubling](https://youtu.be/BRO7mVIFt08?si=Ca5lg-4DSU2pU_q6&t=1553)
    - [X] [Implement with array using chaining](./data-structures/hash_table/main.cpp)
...
- ### Binary search trees: BSTs
    ...
    - [X] [Implement](./data-structures/bst//main.cpp):
